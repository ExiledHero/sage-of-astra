...
using SageOfAstra.Preconditions;
using System;

namespace SageOfAstra.Modules
{
    [Name("Core Commands")]
    ...
    public class CoreModule : ModuleBase
    {
        ...
        [Command("commands"), Summary("Generates commands in a file.")]
        [RequireCustomPermission("core.commands")]
        public async Task GenerateCommands()
        {
            ...
            foreach (var m in _commands.Modules)
            {
                ...
                foreach (var c in m.Commands)
                {
                    ...
                    if (permission != null)
                    {
                        response.AppendLine("Mod Permission:");
            ...
            await Context.Channel.SendFileAsync(stream, "commands.txt");
        }
