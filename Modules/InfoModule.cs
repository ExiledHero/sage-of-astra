...
namespace SageOfAstra.Modules
{
    ...
    public class InfoModule : ModuleBase
    {
        ...
        [Command("bot")]
        [Summary("Returns general information about Sage of Astra")]
        ...
        public async Task Info()
        {
            ...
            StringBuilder response = new StringBuilder("**Sage of Astra Information:**\n")
                .AppendLine($"Runtime: {runtime}")
                .AppendLine($"Uptime: {uptime}")
                .AppendLine("-")
                .AppendLine($"Guilds: {string.Join(", ", _client.Guilds)}")
                .AppendLine("Created by: Carthalion");
