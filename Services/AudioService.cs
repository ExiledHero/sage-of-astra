...
using SageOfAstra.Handlers;

namespace SageOfAstra.Services
{
    public sealed class AudioService
    {
        ...
        public async Task<Embed> LeaveAsync(ulong guildId)
        {
            try
            {
                ...
                return await EmbedHandler.CreateBasicEmbed("Music", $"I've left {channelName}. Thank you for playing some music.", Color.Blue);
            }
